  ...
  return (
    <div>
        <article className='border-2 shadow-md shadow-slate-800 border-purple-600 rounded-md p-4 h-96 flex flex-col justify-between'>
            <div>
                <div className='border-2 border-gray-400 mb-4 rounded-md h-36 p-1 object-fill'>
            ...
            <span>
                {site!=='#' && <a href={site} target='_blank.' className='mt-12 underline decoration-green-400'>live site</a>}
                {github!=='#' && <a href={github} target='_blank.' className='m-10 underline decoration-green-400'>source code</a>}
            </span>
        </article>
    </div>
  )
